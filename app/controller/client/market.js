...
class marketController extends Controller {
  ...
  async addMarket() {
    const { ctx } = this;
    const { Price, condition, region, contacts, pictureD, tradeN, commodityD, storeInformation, } = ctx.request.body;
  ...
  async findAllMarket() {
    const { ctx, app } = this;
    let { Price, condition, region, contacts, pictureD, tradeN, commodityD, storeInformation, limit, page } = ctx.request.body;
  ...
  async editMarket() {
    const { ctx } = this;
    const { Price, condition, region, contacts, pictureD, tradeN, commodityD, storeInformation, id } = ctx.request.body;
    const update = {};
